export default Ember.Route.extend({
  ...
  model: function () {
    ...
    return new Ember.RSVP.Promise(function (resolve, reject) {
      var backupsRef = window.ENV.firebaseRoot.ref('management/backups');
  ...
  setupController: function (controller) {
    ...
    window.ENV.firebaseRoot.ref('management/sites').child(this.get('session.site.name')).child('api-key').once('value', function(snap) {
      var val = snap.val();
